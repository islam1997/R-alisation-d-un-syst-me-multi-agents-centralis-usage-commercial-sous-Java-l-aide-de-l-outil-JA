...
public class Rule {
    ...
    public String name;
    Clause[] antecedents;
    public Clause concequent;
    Boolean truth;
    public ArrayList<Clause> antecedents2;
    ...
    public void update3 (String s1,String s2,String s3,int k)
    {
        antecedents[k].lhs.SetName(s1);
        antecedents[k].cond.setsymbole(s2);
        antecedents[k].rhs=s3;
